...
#define    HOTKEY_TAB_ADD               CTRL(GDK_T) || CTRL_SHIFT(GDK_t)
#define    HOTKEY_TAB_REMOVE            CTRL(GDK_W) || CTRL_SHIFT(GDK_w)
...
#define GTK3_CSS                     "GtkNotebook GtkHBox GtkButton { -GtkWidget-focus-line-width: 0; } GtkNotebook GtkButton { border-width: 0; padding: 0; -GtkButton-inner-border: 5; } GtkWindow GtkNotebook { padding: 0; }"
